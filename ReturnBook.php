...
<html>
	...
	<body class="return-book">
		...
		<div class="form">
			<h2>Return Book</h2>
			<form method="post" action="Includes/ReturnBook.inc.php">
				<p id="text">
					<?php
						if(isset($_GET['text'])==False)
						{
							header("Location: ReturnBook.php?text=");
							exit();
						}
						$text = $_GET['text'];
						echo("$text");
				...
				<i class="fas fa-exchange-alt"></i><br><br>
				...
				<button type="return" name="submit" value="Submit">Return</button>
			</form>
		</div>
	</body>
</html>