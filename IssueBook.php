...
<html>
	...
	<body class="issue-book">
		...
		<div class="form">
			<h2>Issue Book</h2>
			<form method="post" action="Includes/IssueBook.inc.php">
				<p id="text">
					<?php
						if(isset($_GET['text'])==False)
						{
							header("Location: IssueBook.php?text=");
							exit();
						}
						$text = $_GET['text'];
						echo("$text");
				...
				<button type="issue" name="submit" value="Submit">Issue</button>
			</form>
		</div>
	</body>
</html>